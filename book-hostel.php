...
$ccity=$_POST['city'];
$query="insert into  registration(roomno,seater,feespm,stayfrom,duration,course,firstName,lastName,gender,contactno,emailid,
egycontactno,guardianName,guardianRelation,guardianContactno,corresAddress,corresCIty) values(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)";
$stmt = $mysqli->prepare($query);
$rc=$stmt->bind_param('iiisissssisississ',$roomno,$seater,$feespm,$stayfrom,$duration,$course,
$fname,$lname,$gender,$contactno,$emailid,$emcntno,$gurname,$gurrelation,$gurcntno,$caddress,$ccity);
$stmt->execute();
