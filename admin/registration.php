...
$ccity=$_POST['city'];
$query="insert into  registration(roomno,seater,feespm,stayfrom,duration,course,firstName,lastName,gender,contactno,emailid,egycontactno,guardianName,guardianRelation,guardianContactno,corresAddress,corresCIty) values(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)";
$stmt = $mysqli->prepare($query);
$rc=$stmt->bind_param('iiisissssisississ',$roomno,$seater,$feespm,$stayfrom,$duration,$course,$fname,$lname,$gender,$contactno,$emailid,$emcntno,$gurname,$gurrelation,$gurcntno,$caddress,$ccity);
$stmt->execute();
$stmt->close();


$query1="insert into  userregistration(firstName,lastName,gender,contactNo,email,password) values(?,?,?,?,?,?)";
$stmt1= $mysqli->prepare($query1);
$stmt1->bind_param('sssiss',$fname,$lname,$gender,$contactno,$emailid,$contactno);
$stmt1->execute();
...
<label class="col-sm-4 control-label"><h4 style="color: green" align="left">Room Information </h4> </label>
</div>
